// STEP 4: the permission gate. This is the whole "confirm-required" tier in
// ~10 lines: block until a human says yes. Everything interesting about
// harness safety is deciding WHICH tools call this — see tools.ts's tierOf.
//
